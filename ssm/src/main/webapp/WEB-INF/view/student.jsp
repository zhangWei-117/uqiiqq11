...
<div class="row">
    ...
    <div class="col-lg-2">
        <div class="input-group">
            ...
            <select class="form-control" name="txt_search_roleid" id="txt_search_majorid">
            ...
            <div class="modal-body">
                <form id="form_user" method="post" action="reserveStudent.htm">
                    ...
                    <table style="border-collapse:separate; border-spacing:0px 10px;">
                        ...
                        <tr>
                            <td>年龄：</td>
                            <td><input type="text" id="age" name="age" class="form-control" aria-required="true"
                                       required/></td>
                        </tr>
                        <tr>
                            <td>性别：</td>
                            <td>
                                <input type="radio" value="男" id="sex1" name="sex" aria-required="true" required/>男
                                <input type="radio" id="sex2" value="女" name="sex" aria-required="true" required/>女
                            </td>
                        </tr>
                        <tr>
                            <td>专业：</td>
                        ...
                        <tr>
                            <td>生日：</td>
                            <td>
                                <input type="text" id="birthday" name="birthday" aria-required="true" required/>
                            </td>
                        </tr>
                    </table>
...
<div class="ui-jqdialog modal-content" id="alertmod_table_user_mod"
    ...
    <div class="ui-jqdialog-titlebar modal-header" id="alerthd_table_user"
        ...
        <a id="alertmod_table_user_mod_a" class="ui-jqdialog-titlebar-close" style="right: 0.3em;"> <span
...
<script src="${path }/resources/js/plugins/bootstrap-table/locale/bootstrap-table-zh-CN.min.js?1"></script>
    ...
    var TableInit = function () {
        ...
        oTableInit.queryParams = function (params) {
            var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
                ...
                sname: $("#txt_search_sname").val(),//姓名查询
                majorid: $("#txt_search_majorid").val(),//专业查询
...
//修改回显
    function initEditUser(getSelection) {
        //单选框回显数据
        getSelection.status=='男'?$('#sex1').prop("checked",true):$('#sex2').prop("checked",true);
//日期回显
        var t=new Date(getSelection.birthday);
